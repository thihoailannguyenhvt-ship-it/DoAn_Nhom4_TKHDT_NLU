...
public class BanGhiModule4 {
	...
	private final double phanTramGiaoThoa; // Đã đổi tên
	

	public BanGhiModule4(String idConVat, TinhTrangVung nhanVung, double viDo, double kinhDo, String idVung, String loaiVung, 
                         double phanTramGiaoThoa) {
	...
	// Getters
	public String layIdConVat() { return idConVat; }
	public TinhTrangVung layNhanVung() { return nhanVung; }
	public double layViDo() { return viDo; }
	public double layKinhDo() { return kinhDo; }
